...
export async function GET(_context: APIContext) {
  ...
  const lines = [
    '# Musa Yohanes',
    '',
    '> Software developer in Jakarta. Builds workflow automation at a SaaS company. Former financial auditor at PwC and accounting lecturer. This portfolio covers his projects, writing, and experience at the intersection of software and finance.',
    '',
    ...
    `- [Portfolio](${SITE}/projects/): Selected projects across SaaS, workflow automation, data, and finance systems`,
    '',
    '## Blog',
    '',
    ...posts.map(
